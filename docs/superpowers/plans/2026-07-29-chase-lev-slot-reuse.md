...
- [ ] **Step 1: Declare the test-only claim hook**
...
- [ ] **Step 2: Add a post-CAS pause point without changing queue behavior**
...
- [ ] **Step 3: Add the deterministic wraparound regression**
...
- [ ] **Step 4: Run the focused test and prove the old behavior fails**
...
- [ ] **Step 5: Remove the unsafe thief-side slot clear**
...
- [ ] **Step 6: Run focused and repeated regression checks**
...
- [ ] **Step 7: Verify production hook isolation and adjacent correctness**
...
make -j4 asan-test_runtime_shutdown_internal
