 ...
 *  - wait tracking and cancellation/deadline glue in @c runtime_wait_tracking.c,
 *  - timer heap handling in @c runtime_timer.c,
 *  - synchronization wait queues in @c runtime_sync.c,
 *  - and public join/sleep APIs in @c runtime_yield_join_sleep.c.
 *
