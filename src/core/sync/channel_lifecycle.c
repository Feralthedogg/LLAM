/**
 * @file src/core/sync/channel_lifecycle.c
 * @brief Channel public-handle registry, creation, and destruction.
 *
 * @details
 * Channel send/recv paths are kept in channel.c.  This translation
...
static int llam_channel_reserve_public_slot_locked(llam_channel_t *channel, size_t *out_slot) {
    ...
    return llam_public_slot_reserve_family_secret(&g_llam_channel_public_slots,
                                                  channel,
                                                  64U,
